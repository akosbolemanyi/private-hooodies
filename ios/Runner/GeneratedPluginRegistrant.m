...
#if __has_include(<flutter_any_logo/FlutterAnyLogoPlugin.h>)
#import <flutter_any_logo/FlutterAnyLogoPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [FlutterAnyLogoPlugin registerWithRegistrar:[registry registrarForPlugin:@"FlutterAnyLogoPlugin"]];
